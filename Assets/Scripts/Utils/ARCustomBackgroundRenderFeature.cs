...
/// </summary>
public class ARCustomBackgroundRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        {
            ARCoreCustomCameraBackground cameraBackground = currentCamera.gameObject.GetComponent<ARCoreCustomCameraBackground>();
    ...
    abstract class ARCameraBackgroundRenderPass : ScriptableRenderPass
    {
        ...
        public void Setup(ARCoreCustomCameraBackground cameraBackground, bool invertCulling)
        {
        ...
        /// <param name="cameraBackground">The <see cref="ARCameraBackground"/> component that provides the <see cref="Material"/>
        /// and any additional rendering information required by the render pass.</param>
        protected virtual void SetupInternal(ARCoreCustomCameraBackground cameraBackground) {}
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            ARCoreCustomCameraBackground.AddBeforeBackgroundRenderHandler(cmd);
    ...
    class ARCameraAfterOpaquesRenderPass : ARCameraBackgroundRenderPass
    {
        ...
        /// <inheritdoc />
        protected override void SetupInternal(ARCoreCustomCameraBackground cameraBackground)
        {
