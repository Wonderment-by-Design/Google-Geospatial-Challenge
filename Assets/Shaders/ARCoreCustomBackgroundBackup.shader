Shader "Custom/ARCoreCustomBackgroundBackup"
{
    Properties
    {
...
#extension GL_OES_EGL_image_external_essl3 : require
            ...
            void main()
            {
                ...
                //textureCoord2 = TRANSFORM_TEX(gl_MultiTexCoord0, _Semantic);
            ...
            void main()
            {
                ...
                vec2 uvSemantics = vec2(1.0-textureCoord.y, 1.0-textureCoord.x);
                vec3 semantic = texture(_Semantic, uvSemantics).xyz;

                float semanticLabel= round(semantic.r * 255.0);
                if((int)semanticLabel == 1)
